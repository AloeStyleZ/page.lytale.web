...
@Component({
  ...
  templateUrl: './social-dropdown.html',
  styleUrl: './social-dropdown.css'
})
export class SocialDropdownComponent {
  ...
  socialLinks: SocialLink[] = [
    ...
    {
      name: 'Discord',
      url: 'https://discord.gg/sN6y7CvxZX',
      color: 'text-[#5865F2]',
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/lytaleserver/',
      color: 'text-pink-600',
    ...
    {
      name: 'TikTok',
      url: 'https://tiktok.com/@tu-cuenta',
      color: 'text-gray-800 dark:text-gray-200',
